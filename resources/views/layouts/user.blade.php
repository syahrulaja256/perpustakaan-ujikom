...
<body class="flex h-screen overflow-hidden bg-white font-sans">
    ...
    {{-- Sidebar --}}
    <aside class="w-[270px] flex-shrink-0">
    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar-light">
        ...
        <div class="px-8 pt-4">
            ...
            @if (session('error'))
                <div class="toast-enter bg-red-50 border border-red-200 text-red-700 px-5 py-3.5 rounded-xl mb-4 flex items-center gap-3 shadow-sm">
