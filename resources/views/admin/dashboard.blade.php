        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
            ...
            <div class="stat-card bg-[#F3F4F6] rounded-2xl p-6 group">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[10px] font-bold text-[#14B8A6] bg-teal-50 px-3 py-1.5 rounded-lg uppercase tracking-wider">Anggota</span>
                </div>
                <p class="text-3xl font-bold text-gray-800 mb-1 animate-count-up">{{ $totalUser }}</p>
                <p class="text-xs text-gray-500 flex items-center gap-1.5">
                    <i class="fa-solid fa-user-group text-[#14B8A6] text-[10px]"></i>
                    Total User
                </p>
            </div>
            ...
            <div class="stat-card bg-[#F3F4F6] rounded-2xl p-6 group">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/20 group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-clock text-white text-lg"></i>
                    </div>
                    <span class="text-[10px] font-bold text-amber-500 bg-amber-50 px-3 py-1.5 rounded-lg uppercase tracking-wider">Pending</span>
                </div>
                <p class="text-3xl font-bold text-gray-800 mb-1 animate-count-up">{{ $totalMenunggu }}</p>
                <p class="text-xs text-gray-500 flex items-center gap-1.5">
                    <i class="fa-solid fa-hourglass-half text-amber-500 text-[10px]"></i>
                    Menunggu Konfirmasi
                </p>
            </div>
            ...
            <div class="stat-card bg-[#F3F4F6] rounded-2xl p-6 group">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-violet-500 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/20 group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-tags text-white text-lg"></i>
                    </div>
                    <span class="text-[10px] font-bold text-violet-500 bg-violet-50 px-3 py-1.5 rounded-lg uppercase tracking-wider">Label</span>
                </div>
                <p class="text-3xl font-bold text-gray-800 mb-1 animate-count-up">{{ $totalKategori }}</p>
                <p class="text-xs text-gray-500 flex items-center gap-1.5">
                    <i class="fa-solid fa-tag text-violet-500 text-[10px]"></i>
                    Total Kategori
                </p>
            </div>
            ...
            {{-- Ulasan --}}
            <a href="{{ route('admin.ulasan.index') }}" class="stat-card bg-[#F3F4F6] rounded-2xl p-6 group cursor-pointer hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-yellow-400 rounded-xl flex items-center justify-center shadow-lg shadow-yellow-400/20 group-hover:scale-110 transition-transform duration-300">
                        <i class="fa-solid fa-star text-white text-lg"></i>
                    </div>
                    <span class="text-[10px] font-bold text-yellow-500 bg-yellow-50 px-3 py-1.5 rounded-lg uppercase tracking-wider">Rating</span>
                </div>
                <p class="text-3xl font-bold text-gray-800 mb-1 animate-count-up">{{ $totalUlasan }}</p>
                <p class="text-xs text-gray-500 flex items-center gap-1.5">
        ...
        <div class="bg-[#F3F4F6] rounded-2xl p-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <a href="{{ route('admin.petugas') }}"
                    class="flex items-center gap-3 p-4 bg-white rounded-xl hover:shadow-md hover:-translate-y-0.5 border border-gray-100 transition-all duration-300 group">
                    <div class="w-10 h-10 bg-teal-50 rounded-lg flex items-center justify-center group-hover:bg-[#14B8A6] transition-colors duration-300">
                        <i class="fa-solid fa-user-plus text-[#14B8A6] text-sm group-hover:text-white transition-colors duration-300"></i>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-gray-700">Kelola</p>
