...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { font-size: 20px; color: #0891b2; margin-bottom: 3px; }
        .header p { font-size: 11px; color: #666; }
        table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        th { background: #0891b2; color: white; padding: 8px 10px; text-align: left; font-size: 11px; font-weight: bold; }
...
<body>
    ...
    <div class="header">
        ...
        <p>Laporan Data Peminjaman Buku (Petugas)</p>
        <p style="margin-top:5px; font-size:10px;">Dicetak: {{ date('d F Y, H:i') }}</p>
    </div>

    <p style="margin-bottom:10px; font-size:11px; color:#666;">Total data: <strong>{{ count($laporan) }}</strong> peminjaman</p>
